...
type Driver interface {
	...
	// pulses) plus the DPS/REX input lines for a portal. A dps/rex index of 0 means
	// "not wired" and is skipped. On any partial failure it releases what it had
	// already requested and returns an error.
